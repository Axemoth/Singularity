...
function AgentPageContent() {
  ...
  // Queries for connected accounts & subscription status
  ...
  return (
    <div className="flex h-full animate-fade-in overflow-hidden">
      ...
      <div className="flex-1 flex flex-col bg-bg-base overflow-hidden">
              ...
              return (
                <div key={message.id} className="space-y-2.5">
                  ...
                  <div className={`flex flex-col ${message.role === "user" ? "items-end" : "items-start"}`}>
                    <div
                      className={`max-w-[90%] rounded-xl px-4 py-3 text-[13px] leading-relaxed shadow-sm break-words ${
                        message.role === "user"
        ...
        {/* Input area */}
        <div className="border-t border-border-subtle p-6 bg-bg-base shrink-0 relative">
          <div className="max-w-2xl mx-auto relative">
            {/* Slash commands menu */}
            {showCommandMenu && filteredCommands.length > 0 && (
              <div className="absolute bottom-full left-0 right-0 mb-2 bg-bg-surface/95 backdrop-blur-md border border-border-default rounded-xl shadow-lg z-50 py-1.5 max-h-48 overflow-y-auto">
            ...
            {/* Form */}
            <form onSubmit={handleSubmit} className="flex flex-col gap-2 rounded-xl border-none bg-bg-surface p-2.5 shadow-sm focus-within:shadow-md transition-all focus-within:bg-bg-base outline-none focus-within:outline-none focus-within:ring-0">
              {targetEmail && (
