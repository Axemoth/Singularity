  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0a0f]">
      ...
      <div className="animate-slide-up relative z-10 mx-4 w-full max-w-md">
        {/* Card */}
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 px-8 py-12 shadow-2xl shadow-black/60 backdrop-blur-xl sm:px-10 sm:py-14">
          ...
          <div className="relative flex flex-col items-center">
            <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 via-violet-500 to-purple-600 shadow-2xl shadow-indigo-500/40">
              <span className="animate-shimmer absolute inset-0 -skew-x-12 rounded-2xl bg-gradient-to-r from-transparent via-white/20 to-transparent" />
              <span className="relative text-3xl font-bold leading-none tracking-tight text-white">S</span>
            </div>

            <h1 className="mt-6 text-3xl font-bold tracking-tight text-white sm:text-4xl">Singularity</h1>
            <p className="mt-2 text-sm tracking-wide text-white/45 sm:text-base">Email & Calendar, Reimagined</p>
          </div>

          {/* Divider */}
          <div className="my-8 h-px w-full bg-gradient-to-r from-transparent via-white/15 to-transparent" />

          <p className="mb-6 text-center text-sm text-white/50">Sign in to access your unified workspace</p>
