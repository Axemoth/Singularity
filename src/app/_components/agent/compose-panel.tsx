          ...
          <div className="border-t border-border-subtle p-3 bg-bg-raised">
            ...
            <form onSubmit={handleChatSubmit} className="flex gap-2 items-end">
              <textarea
                ...
                className="border border-border-default bg-bg-inset text-text-primary placeholder:text-text-tertiary focus:border-accent-primary min-h-[44px] flex-1 resize-none rounded-[var(--radius-md)] px-3 py-2 text-xs transition-colors outline-none focus:bg-bg-base"
              />
              <Button
                type="submit"
                isLoading={chat.isPending}
                className="h-[44px] px-4 cursor-pointer font-semibold uppercase tracking-wider text-[10px]"
              >
                Send
              </Button>
            </form>
